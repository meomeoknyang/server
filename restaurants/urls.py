...
from .views import RestaurantViewSet, RestaurantDetailView, RestaurantLocationView, FilteredRestaurantLocationView, RandomRestaurantView
...
urlpatterns = [
    ...
    path('restaurants/random', RandomRestaurantView.as_view(), name='random-restaurant'),
]
